...
public class BlogController {
    ...
    public String showCreateForm(Model model, Principal principal,RedirectAttributes redirectAttributes) {
        if(principal != null){
            model.addAttribute("blog", new Blog());
            return "blog/create";
        }else {
            redirectAttributes.addFlashAttribute("message","You can login to create new blog!!!");
            return "/blog/list";
        }
