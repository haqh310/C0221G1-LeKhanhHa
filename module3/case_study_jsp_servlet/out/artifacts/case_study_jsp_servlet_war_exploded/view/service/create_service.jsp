        ...
        <div class="col-6 d-flex flex-column">
            ...
            <form action="/services?action=create" method="post" class="container border border-dark mb-3 pt-3">
                ...
                <div id="standard_room" class="form-group">
                    ...
                    <input id="input_standard_room" type="text" class="form-control" name="standard_room" placeholder="Enter standard room... ">
                </div>
                <div id="description_other_convenience" class="form-group">
                    ...
                    <input id="input_description_other_convenience" type="text" class="form-control" name="description_other_convenience"
                           placeholder="Enter description other convenience... ">
                </div>
...
<script>
    function myFunction() {
        ...
        if (id == 2) {
            ...
            document.getElementById("input_standard_room").value = null;
            document.getElementById("input_description_other_convenience").value = null;
            document.getElementById("input_pool_area").value = null;
            document.getElementById("input_number_of_floors").value = null;
        }
    }
