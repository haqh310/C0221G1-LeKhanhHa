...
public class Contract {
    ...
    public Contract( Date contract_start_date, Date contract_end_date, double contract_deposit, double contract_total_money, int employee_id, int customer_id, int service_id) {
        this.contract_start_date = contract_start_date;
        this.contract_end_date = contract_end_date;
        this.contract_deposit = contract_deposit;
        this.contract_total_money = contract_total_money;
