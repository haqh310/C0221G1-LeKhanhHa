        ...
        <div class="col-6 d-flex flex-column">
            ...
            <form action="/services?action=create" method="post" class="container border border-dark mb-3 pt-3">
                <div class="form-group">
                    <label>Code:</label>
                    <input type="text" class="form-control" name="service_code" placeholder="Enter code... " value="${service.service_code}">
                ...
                <div class="form-group">
                    <label>Name:</label>
                    <input type="text" class="form-control" name="service_name" placeholder="Enter name..." value="${service.service_name}">
                </div>
                <div class="form-group">
                    <label>Area:</label>
                    <input type="number" class="form-control" name="service_area" placeholder="Enter area... " value="${service.service_area}">
                ...
                <div class="form-group">
                    <label>Cost:</label>
                    <input type="text" class="form-control" name="service_cost" placeholder="Enter cost..." value="${service.service_cost}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="service_max_people"
                           placeholder="Enter max people..." value="${service.service_max_people}">
                ...
                <div class="form-group">
                    ...
                    <select id="service_type_id" name="service_type_id" class="form-control" onchange="myFunction()">
                ...
                <div id="standard_room" class="form-group">
                    ...
                    <input id="input_standard_room" type="text" class="form-control" name="standard_room" placeholder="Enter standard room..." value="${service.standard_room}">
                </div>
                <div id="description_other_convenience" class="form-group">
                    <label>Description other convenience:</label>
                    <input id="input_description_other_convenience" type="text" class="form-control" name="description_other_convenience"
                           placeholder="Enter description other convenience..." value="${service.description_other_convenience}">
                </div>
                <div id="pool_area" class="form-group">
                    <label>Pool area:</label>
                    <input id="input_pool_area" type="number" class="form-control" name="pool_area"
                           placeholder="Enter pool area..." value="${service.pool_area}">
                ...
                <div id="number_of_floors" class="form-group">
                    ...
                    <input id="input_number_of_floors" type="number" class="form-control" name="number_of_floors"
                           placeholder="Enter number of floors..." value="${service.number_of_floors}">
