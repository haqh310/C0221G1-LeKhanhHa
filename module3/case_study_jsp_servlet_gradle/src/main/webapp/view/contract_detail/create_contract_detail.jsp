...
<div class="row">
    <div class="container d-flex justify-content-center">
        <div class="col-6 d-flex flex-column">
            ...
            <p>
                <a href="/contract_details?action=view&contract_id=${contract_id}">Back to menu</a>
            </p>
            <form action="/contract_details?action=create" method="post" class="container border border-dark mb-3 pt-3">
