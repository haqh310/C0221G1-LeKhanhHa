...
public class ServiceRepository implements IRepository<Service> {
    ...
    private final String INSERT_SERVICE = " insert into service(service_code, service_name,service_area,service_cost,service_max_people,rent_type_id,service_type_id,standard_room,description_other_convenience,pool_area,number_of_floors)" +
            "values(?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public List<Service> findAll() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                services.add(new Service(service_id,service_code, service_name, service_area, service_cost, service_max_people, rent_type_id, service_type_id, standard_room, description_other_convenience, pool_area, number_of_floors));
            }
            statement.close();
            connection.close();
    ...
    public Service findById(int id) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String pool_area = resultSet.getString("pool_area");
                String number_of_floors = resultSet.getString("number_of_floors");
                service = new Service(service_id,service_code, service_name, service_area, service_cost, service_max_people, rent_type_id, service_type_id, standard_room, description_other_convenience, pool_area, number_of_floors);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
